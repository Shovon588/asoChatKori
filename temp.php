                ...
                <table class="table table-striped table-dark" style="width:65%">
                    ...
                    <tbody>
                        <tr>
                            ...
                            if ($matchemail > 0) {
                                $task = 0;
                                echo "<td>" . "<a href='temp.php?who=$myEmail&withWho=$email&task=$task' style='font-size=20px'><i class='fas fa-user-friends' data-toggle='tooltip' title='You guys are already friend'></i></a>" . "</td>";
                            } else {
                                $task = 1;
                                echo "<td>" . "<a href='temp.php?who=$myEmail&withWho=$email&task=$task' style='font-size=20px'><i class='fas fa-user-plus' data-toggle='tooltip' title='Add friend'></i></a>" . "</td>";
                            }
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-12 col-md-10 col-lg-8">
            ...
            <form class="card card-sm" style="border:2px solid black;" method="post" action="temp.php">
